...
const Header = () => {
  return (
    <header className=" relative  lg:text-black text-neutral-700 lg:items-center items-end lg:justify-between  justify-center px-4    overflow-hidden z-30  w-full  flex  ">
